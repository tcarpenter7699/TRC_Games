    ...
    return (
        <>
            <div className="homePage">
                <div className="intro">
                    <div className="title">
                        <h1 id="titleText">Welcome to TRC Games</h1>
                        <h2 id="hookQuote">Here is a collection of games I've played!</h2>
                        {/* <Link to={"/menu"}>
                ...
                <div id="popularItems" ref={divRef}>
                    ...
                    <div id="butStatement">
                        <h2>Top Reviews</h2>
                        <h3>Here's the top reviewed games in the catelog!</h3>
                    </div>
                    <div id="toTopItems">
                            ...
                            <div className="reviewCard" key={review.id}>
                                <div className="reviewItem">
                                    <div className="reviewImgHolder">
                                        <img className="reviewImg" src={review.game.imageUrl}/>
                                    </div>
                                    <h2>{review.game.name}</h2>

                                    {/*CHANGE THIS BUTTON LATER TO LEAD TO SINGLE ITEM*/}
                                    <button className="tryItem"><Link to={`/menu/${review.game.id}`}>Try it!</Link></button>
