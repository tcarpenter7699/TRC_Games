    ...
    return (
        <>
            <div id="singleItemContainer">
                <div id="item">
                    <img src={game.imageUrl} id="singleItemImg"/>
                    ...
                    <div id="itemDetails">
                        ...
                        <h2 id="itemDesc">{game.developer}</h2>
                        <h2 id="itemDesc">{game.year}</h2>
                        <h2 id="itemDesc">{game.platform}</h2>
                        <h2 id="itemDesc">{game.description}</h2>
                ...
                <div id="itemReviewSection">
                    <div id="reviewForm">
                        <div id="ratingHolder">
                            <h2>What do you think about this game?</h2>
                    ...
                    <div id="itemReviews">
                        {reviews.length>0?<h2>This is what other people think!</h2>:<h2>Be the first to leave a review!</h2>}
                        {reviews.map((review)=>{
                            return(
